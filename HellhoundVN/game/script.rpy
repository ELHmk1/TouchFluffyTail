...
label tease:
    "The quickest way to get her to perk up is going to be ribbing her a little."
    ...
    "It's her way of letting me know that if she's pushing too hard I can let her know."
    "But honestly?"
...
label comfort:  
    show fia c_neutral with dissolve
    f "Hurry up and write this scene!"
    jump wetshirt
...
label apartment:
    ...
    show fia cw_pout with dissolve
    f "I'm soaking wet!"
    mc "True, but you're always wet around me."
    "That earns me a playful punch on the arm"
    f "Oh stop. I'm going to take a shower, you coming?"
